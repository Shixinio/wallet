...
var BRS = (function(BRS, $, undefined) {
	...
	if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode != 5) {
	    ...
	    if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode == 5) {
		$("#account_balance_balance, #account_balance_unconfirmed_balance, #account_balance_effective_balance, #account_balance_guaranteed_balance").html("0 COWBOY");
		...
		$("#account_balance_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.balanceNQT)) + " COWBOY");
		$("#account_balance_unconfirmed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.unconfirmedBalanceNQT)) + " COWBOY");
		$("#account_balance_effective_balance").html(BRS.formatAmount(BRS.accountInfo.effectiveBalanceCOWBOY) + " COWBOY");
		$("#account_balance_guaranteed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.guaranteedBalanceNQT)) + " COWBOY");
