...
final class SubmitNonce extends APIServlet.JsonRequestHandler {
  ...
  SubmitNonce(PropertyService propertyService, AccountService accountService, Blockchain blockchain, Generator generator,BlockService blockService) {
  ...
  JsonElement processRequest(HttpServletRequest req) {
    ...
    if(secretAccount != null) {
      try {
        SubmitNonceHandler.verifySecretAccount(accountService, blockchain, secretAccount, Convert.parseUnsignedLong(accountId),blockService);
