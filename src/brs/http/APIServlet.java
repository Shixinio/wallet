...
public final class APIServlet extends HttpServlet {
  ...
  public APIServlet(TransactionProcessor transactionProcessor, Blockchain blockchain, BlockchainProcessor blockchainProcessor, ParameterService parameterService,
    ...
    map.put("getAccount", new GetAccount(parameterService, accountService, blockService));
    ...
    map.put("submitNonce", new SubmitNonce(propertyService, accountService, blockchain, generator, blockService));
