...
public class BurstGUI extends Application {
    ...
    private static final String FAILED_TO_START_MESSAGE = "CowboyGUI caught exception starting CBW";
    private static final String UNEXPECTED_EXIT_MESSAGE = "CBW Quit unexpectedly! Exit code ";
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Cowboy version " + Burst.VERSION);
    ...
    private TrayIcon createTrayIcon() {
        try {
            ...
            MenuItem showItem = new MenuItem("Show CBW output");
            MenuItem shutdownItem = new MenuItem("Shutdown CBW");
            ...
            TrayIcon newTrayIcon = new TrayIcon(Toolkit.getDefaultToolkit().createImage(BurstGUI.class.getResource(ICON_LOCATION)), "Cowboy Software", popupMenu);
