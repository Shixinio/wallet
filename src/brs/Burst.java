...
public final class Burst {
  ...
  public static final String APPLICATION = "CBW";
  ...
  private static PropertyService loadProperties() {
    ...
    logger.info("Initializing Cowboy Reference Software (CBW) version {}", VERSION);
  ...
  private static void loadWallet(PropertyService propertyService) {
    ...
    try {
      ...
      logger.info("CBW {} started successfully.", VERSION);
  ...
  public static void shutdown(boolean ignoreDBShutdown) {
    ...
    logger.info("CBW {} stopped.", VERSION);
